...
// import lotteryABI from "../abi/pancakeswaplotteryabi";
 ...
 */
 const getTicketPrice = async (
  ...
  const price = new BigNumber(answer.toString()).div(1e8);

  // Compute the ticket price (denominated in $Cake), to the required USD eq. value.
  const ticketPrice = new BigNumber(usd).div(price);
...
// export const isTimeToRun = async (networkName)=> {
//   let attempt = 1;
//   let error;
//   let isTime = true;
//   while (attempt < 6) {
...
module.exports={getEndTime,getTicketPrice}